let users = {
  simba: {
    id: "simba",
    name: "Simba",
    avatarURL: "https://res.cloudinary.com/dn9xhnktx/image/upload/v1650542773/the-lion-king-conversation/simba_iwuoq4.png",
    tweets: ['5c9qojr2d1738zlx09afby', '5w6k1n34dkp1x29cuzn2zn', '2mb6re13q842wu8n106bhk'],
  },
  pumba: {
    id: "pumba",
    name: "Pumba",
    avatarURL: "https://res.cloudinary.com/dn9xhnktx/image/upload/v1650542227/the-lion-king-conversation/Pumba_xzkidr.png",
    tweets: [],
  },
  timon: {
    id: "timon",
    name: "Timon",
    avatarURL: 'https://res.cloudinary.com/dn9xhnktx/image/upload/v1650541652/the-lion-king-conversation/timon_ehd2z2.png',
    tweets: ['hbsc73kzqi75rg7v1e0i6a', 'czpa59mg577x1oo45cup0d', 'nnvkjqoevs8t02lzcc0ky'],
  },
  mufasa: {
    id: "mufasa",
    name: "Mufasa",
    avatarURL: "https://res.cloudinary.com/dn9xhnktx/image/upload/v1650542177/the-lion-king-conversation/mufasa_ysduh0.png",
    tweets: ['8xf0y6ziyjabvozdd253nd', 'f4xzgapq7mu783k9t02ghx'],
  },
  rafiki: {
    id: "rafiki",
    name: "Rafiki",
    avatarURL: "https://res.cloudinary.com/dn9xhnktx/image/upload/v1650542983/the-lion-king-conversation/rafiki_xziu56.png",
    tweets: [],
  },
}
...
let tweets = {
  "8xf0y6ziyjabvozdd253nd": {
    ...
    text: "Everything you see exists together in a delicate balance. As king, you need to understand that balance and respect all the creatures, from the crawling ant to the leaping antelope.",
    author: "mufasa",
    timestamp: 1587296511000,
    likes: ['rafiki'],
    replies: ['5c9qojr2d1738zlx09afby', 'f4xzgapq7mu783k9t02ghx'],
    replyingTo: null,
  },
  "5c9qojr2d1738zlx09afby": {
    id: "5c9qojr2d1738zlx09afby",
    text: "But, Dad, don't we eat the antelope?",
    author: "simba",
    timestamp: 1587296471000,
    likes: ['rafiki'],
    replies: [],
  ...
  "f4xzgapq7mu783k9t02ghx": {
    ...
    text: "Yes, Simba, but let me explain. When we die, our bodies become the grass, and the antelope eat the grass. And so we are all connected in the great Circle of Life.",
    author: "mufasa",
    timestamp: 1587296511000,
    likes: ['rafiki'],
    replies: [],
  ...
  "hbsc73kzqi75rg7v1e0i6a": {
    ...
    text: "Hyenas. I hate hyenas. So what your plan for getting past those guys?",
    author: "timon",
    timestamp: 1595169711000,
    likes: [],
    replies: ['5w6k1n34dkp1x29cuzn2zn', 'czpa59mg577x1oo45cup0d', '2mb6re13q842wu8n106bhk', 'nnvkjqoevs8t02lzcc0ky'],
    replyingTo: null,
  },
  ...
  "2mb6re13q842wu8n106bhk": {
    ...
    text: "Come on, Timon! You guys have to create a diversion.",
    author: "simba",
    timestamp: 1595169855000,
    likes: ['mufasa'],
    replies: [],
    replyingTo: 'hbsc73kzqi75rg7v1e0i6a',
  },
